...
extension UIColor {
    public static let themeYellowD = UIColor(hex: 0x0b779c)
    public static let themeYellowL = UIColor(hex: 0x0b779c)
    ...
    public static let themeYellow50 = UIColor(hex: 0x0b779c, alpha: 0.5)
    public static let themeYellow20 = UIColor(hex: 0x0b779c, alpha: 0.2)
